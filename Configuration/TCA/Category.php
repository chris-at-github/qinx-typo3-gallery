...
$GLOBALS['TCA']['tx_qxgallery_domain_model_category'] = array(
	'ctrl' => $GLOBALS['TCA']['tx_qxgallery_domain_model_category']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:qxgallery/Resources/Private/Language/locallang_db.xlf:tx_qxgallery_domain_model_category.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
