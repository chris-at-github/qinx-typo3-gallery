	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table' => 'tx_qxgallery_domain_model_image',
				'foreign_table_where' => 'AND tx_qxgallery_domain_model_image.pid=###CURRENT_PID### AND tx_qxgallery_domain_model_image.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:qxgallery/Resources/Private/Language/locallang_db.xlf:tx_qxgallery_domain_model_image.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
